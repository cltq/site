...
export default function SecondDiscordProfile() {
  const { presence, loading } = useDiscordPresence({ apiBaseUrl: "/api/discord2" });

  if (loading) {
    return (
      <div
        className="flex w-full items-center gap-3 rounded-xl border border-white/[0.06] bg-gradient-to-br from-[#111111] via-[#141414] to-[#171717] px-4 py-3"
  ...
  const handle = presence?.username ?? "unknown";
  ...
  return (
    <div
      className="group flex w-full items-center gap-3 rounded-xl border border-white/[0.06] bg-gradient-to-br from-[#111111] via-[#141414] to-[#171717] px-4 py-3 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:border-white/[0.12]"
      style={{ boxShadow: "0 10px 40px rgba(0,0,0,.35)" }}
    >
      {avatar && (
        <img
