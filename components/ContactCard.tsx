...
import type { ContactCardIcon, ContactCardPlatform } from "@/lib/platforms";
...
export default function ContactCard({ platform }: ContactCardProps) {
  return (
    <div
      className="group flex items-center gap-4 rounded-2xl border border-white/[0.06] bg-gradient-to-br from-[#111111] via-[#141414] to-[#171717] px-5 py-4 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:border-white/[0.12]"
