...
function HeatmapCellInner({ day }: HeatmapCellProps) {
  ...
  return (
    <div
      ...
      aria-label={label}
      title={label}
      className="h-[12px] w-[12px] rounded-[2px] transition-all duration-150 outline-none hover:scale-150 hover:brightness-125 focus:ring-1 focus:ring-white/50 focus:ring-offset-1 focus:ring-offset-[#0a0a0a] sm:h-[13px] sm:w-[13px]"
