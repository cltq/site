...
const getMaxParticles = (): number => {
  ...
  const deviceMemory = (navigator as Navigator & { deviceMemory?: number }).deviceMemory ?? 8; // GB
...
export default function CursorTrail() {
  ...
  return (
    <canvas ref={canvasRef} className="pointer-events-none fixed inset-0 z-[70]" aria-hidden />
  );
}
