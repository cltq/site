...
export default function BioPage() {
  return (
    <div className="flex flex-col">
      ...
      >
        <Reveal className="flex w-full max-w-lg flex-col items-center gap-10 text-center sm:gap-12">
          <div className="flex w-full flex-col items-center gap-2">
            <p className="mb-2 w-full text-left text-xs tracking-widest text-[#737373]">— bio</p>
